    ...
    try:
        ...
        if updated:
            try:
                ...
                print(f"🔌 [002_norm] Updated config.json with missing fields.")
...
def process(file_path):
    ...
    try:
        ...
        result = subprocess.run([ffmpeg_bin, "-i", file_path], stderr=subprocess.PIPE, stdout=subprocess.PIPE, text=True)
